...
public class ImageTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    private Teapot mTeapot;                   //*********************************************************************************** D E L E T E
    //private CubeTest2 mTeapot;      //*********************************************************************************** A D D

    private float kBuildingScale = 0.012f;
    //private float kBuildingScale = 0.00001f;
    private SampleApplication3DModel mBuildingsModel;

    private boolean mIsActive = false;
    private boolean mModelIsLoaded = false;

    //private static final float OBJECT_SCALE_FLOAT = 0.003f;       //**********************************************************D E L E T E
    private static final float OBJECT_SCALE_FLOAT = 0.05f; //**************************************************** A D D
    //private static final float OBJECT_SCALE_FLOAT = 0.00001f; //**************************************************** A D D
    ...
    private void initRendering()
    {
        ...
        if(!mModelIsLoaded) {
            mTeapot = new Teapot();               //******************************************************************** D E L E T E
            //mTeapot = new CubeTest2();  //******************************************************************** A D D
            try {
            ...
            if (!mActivity.isExtendedTrackingActive()) {
                ...
                /*GLES20.glDrawElements(GLES20.GL_TRIANGLES,
                       mTeapot.getNumObjectIndex(), GLES20.GL_UNSIGNED_SHORT,
                        mTeapot.getIndices());*/        //*********************************************************************** D E L E T E
                //GLES20.glDrawArrays(GLES20.GL_TRIANGLES, 0, mTeapot.getNumObjectVertex());  //***** A D D
                GLES20.glDrawElements(GLES20.GL_TRIANGLES,
                        mTeapot.getNumObjectIndex(), GLES20.GL_UNSIGNED_SHORT,
                        mTeapot.getIndices());
