...
public class AboutScreen extends Activity implements OnClickListener
{
    ...
    private void startARActivity()
    {
        ...
        stringBuilder.append(mClassToLaunch);    //mClassToLaunchPackage >> com.vuforia.samples.VuforiaSamples
        Intent i = new Intent();
        i.setClassName(mClassToLaunchPackage, mClassToLaunch);  //mClassToLaunch >> com.vuforia.samples.VuforiaSamples.app.ImageTargets.ImageTargets
        //Log.i("mClassToLaunch3333333333333333",stringBuilder.toString());
        startActivity(i);
    }
